// The environment neutral surface: linking, parsing, and types, with no
// reference to WebGPU. Node tooling imports this so that WebGPU globals
// aren't required to typecheck. Browser code imports "wesl" instead.
